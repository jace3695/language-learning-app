...
export const SENTENCES: SentenceItem[] = ([
  ...
  { japanese: "この近くにATMはありますか？", reading: "このちかくにエーティーエムはありますか？", /* TODO: rubySegments 수동 확인 필요 */ /* TODO: rubySegments 수동 확인 필요 */ koreanPronunciation: "코노 치카쿠니 에이티이에무와 아리마스카?", meaning: "이 근처에 ATM이 있나요?", category: "여행", note: "현금이 필요할 때", description: "주변 금융기기 위치를 물을 때" },
  { japanese: "一番近い駅はどこですか？", reading: "いちばんちかいえきはどこですか？", /* TODO: rubySegments 수동 확인 필요 */ /* TODO: rubySegments 수동 확인 필요 */ koreanPronunciation: "이치방 치카이 에키와 도코데스카?", meaning: "가장 가까운 역은 어디인가요?", category: "여행", note: "역 위치를 물을 때", description: "도보로 갈 수 있는 가까운 역을 찾을 때" },
