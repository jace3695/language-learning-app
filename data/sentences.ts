...
export const SENTENCES: SentenceItem[] = ([
  ...
  { level: "practical", japanese: "ここから遠いですか？", rubySegments: [{ text: "ここから" }, { text: "遠", reading: "とお" }, { text: "いですか？" }], koreanPronunciation: "코코카라 토오이데스카?", meaning: "여기서 멀어요?", category: "여행", note: "거리감을 물을 때" },
  ...
  { japanese: "チェックインお願いします", rubySegments: [{ text: "チェックインお" }, { text: "願", reading: "ねが" }, { text: "いします" }], koreanPronunciation: "첵쿠인 오네가이시마스", meaning: "체크인 부탁합니다", category: "여행", note: "호텔 체크인할 때" },
  { japanese: "チェックアウトは何時ですか？", rubySegments: [{ text: "チェックアウトは" }, { text: "何時", reading: "なんじ" }, { text: "ですか？" }], koreanPronunciation: "첵쿠아우토와 난지데스카?", meaning: "체크아웃은 몇 시예요?", category: "여행", note: "호텔 체크아웃 시간을 물을 때" },
  ...
  { japanese: "ゆっくり話してください", rubySegments: [{ text: "ゆっくり" }, { text: "話", reading: "はな" }, { text: "してください" }], koreanPronunciation: "윳쿠리 하나시테 쿠다사이", meaning: "천천히 말해 주세요", category: "여행", note: "상대 말이 빠를 때" },
  { japanese: "もう一度お願いします", rubySegments: [{ text: "もう" }, { text: "一度", reading: "いちど" }, { text: "お願いします" }], koreanPronunciation: "모오 이치도 오네가이시마스", meaning: "한 번 더 부탁합니다", category: "여행", note: "다시 말해 달라고 할 때" },
  ...
  { japanese: "この近くにコンビニはありますか？", rubySegments: [{ text: "この" }, { text: "近", reading: "ちか" }, { text: "くにコンビニはありますか？" }], koreanPronunciation: "코노 치카쿠니 콘비니와 아리마스카?", meaning: "이 근처에 편의점이 있나요?", category: "여행", note: "근처 편의시설을 찾을 때" },
  ...
  { japanese: "ここに行きたいです", rubySegments: [{ text: "ここに" }, { text: "行", reading: "い" }, { text: "きたいです" }], koreanPronunciation: "코코니 이키타이데스", meaning: "여기에 가고 싶어요", category: "여행", note: "지도나 주소를 보여주며 말할 때" },
  { japanese: "タクシーを呼んでください", rubySegments: [{ text: "タクシーを" }, { text: "呼", reading: "よ" }, { text: "んでください" }], koreanPronunciation: "타쿠시오 욘데 쿠다사이", meaning: "택시를 불러 주세요", category: "여행", note: "택시 호출을 요청할 때" },
  ...
  { level: "beginner", japanese: "ご連絡ありがとうございます", rubySegments: [{ text: "ご" }, { text: "連絡", reading: "れんらく" }, { text: "ありがとうございます" }], koreanPronunciation: "고렌라쿠 아리가토오 고자이마스", meaning: "연락 감사합니다", category: "업무", note: "상대의 연락에 감사할 때" },
  ...
  { level: "basic", japanese: "内容を確認中です", rubySegments: [{ text: "内容を" }, { text: "確認", reading: "かくにん" }, { text: "中です" }], koreanPronunciation: "나이요오오 카쿠닌추우데스", meaning: "내용 확인 중입니다", category: "업무", note: "검토 중임을 알릴 때" },
  ...
  { level: "practical", japanese: "後ほどご連絡いたします", rubySegments: [{ text: "後ほどご" }, { text: "連絡", reading: "れんらく" }, { text: "いたします" }], koreanPronunciation: "노치호도 고렌라쿠 이타시마스", meaning: "나중에 연락드리겠습니다", category: "업무", note: "추후 연락을 약속할 때" },
  ...
  { japanese: "図面を送付してください", rubySegments: [{ text: "図面を" }, { text: "送付", reading: "そうふ" }, { text: "してください" }], koreanPronunciation: "즈멘오 소오후시테 쿠다사이", meaning: "도면을 송부해 주세요", category: "업무", note: "도면 요청 시" },
  ...
  { japanese: "早急に対応お願いします", rubySegments: [{ text: "早急に" }, { text: "対応", reading: "たいおう" }, { text: "お願いします" }], koreanPronunciation: "소오큐우니 타이오오 오네가이시마스", meaning: "조속한 대응 부탁드립니다", category: "업무", note: "긴급 대응을 요청할 때" },
  ...
  { japanese: "ご対応ありがとうございます", rubySegments: [{ text: "ご" }, { text: "対応", reading: "たいおう" }, { text: "ありがとうございます" }], koreanPronunciation: "고타이오오 아리가토오 고자이마스", meaning: "대응 감사합니다", category: "업무", note: "처리에 감사할 때" },
  ...
  { level: "basic", japanese: "どこ行く？", rubySegments: [{ text: "どこ" }, { text: "行", reading: "い" }, { text: "く？" }], koreanPronunciation: "도코 이쿠?", meaning: "어디 갈래?", category: "친구", note: "갈 장소를 물을 때" },
  { level: "basic", japanese: "ご飯食べた？", rubySegments: [{ text: "ご" }, { text: "飯", reading: "はん" }, { text: "食", reading: "た" }, { text: "べた？" }], koreanPronunciation: "고한 타베타?", meaning: "밥 먹었어?", category: "친구", note: "일상적으로 안부를 물을 때" },
  { level: "basic", japanese: "あとで会おう", rubySegments: [{ text: "あとで" }, { text: "会", reading: "あ" }, { text: "おう" }], koreanPronunciation: "아토데 아오오", meaning: "나중에 만나자", category: "친구", note: "나중에 만날 약속을 할 때" },
  ...
  { japanese: "ちょっと待って", rubySegments: [{ text: "ちょっと" }, { text: "待", reading: "ま" }, { text: "って" }], koreanPronunciation: "촛토 맛테", meaning: "잠깐만", category: "친구", note: "잠시 기다려 달라고 할 때" },
  ...
  { japanese: "また行こう", rubySegments: [{ text: "また" }, { text: "行", reading: "い" }, { text: "こう" }], koreanPronunciation: "마타 이코오", meaning: "또 가자", category: "친구", note: "다음 약속을 자연스럽게 말할 때" },
  ...
  { japanese: "いいと思う", rubySegments: [{ text: "いいと" }, { text: "思", reading: "おも" }, { text: "う" }], koreanPronunciation: "이이토 오모우", meaning: "좋다고 생각해", category: "친구", note: "의견을 말할 때" },
  { japanese: "ちょっと難しい", rubySegments: [{ text: "ちょっと" }, { text: "難", reading: "むずか" }, { text: "しい" }], koreanPronunciation: "촛토 무즈카시이", meaning: "조금 어려워", category: "친구", note: "난이도나 상황을 말할 때" },
  ...
  { japanese: "おはよう、今日も頑張ろう。", rubySegments: [{ text: "おはよう、" }, { text: "今日", reading: "きょう" }, { text: "も" }, { text: "頑張", reading: "がんば" }, { text: "ろう。" }], reading: "おはよう、きょうもがんばろう。", koreanPronunciation: "오하요오, 쿄오모 간바로오", meaning: "좋은 아침, 오늘도 힘내자.", category: "친구", note: "아침 인사", description: "친구에게 가볍게 응원하며 인사할 때" },
  ...
  { japanese: "もう着いたよ。", rubySegments: [{ text: "もう" }, { text: "着", reading: "つ" }, { text: "いたよ。" }], reading: "もうついたよ。", koreanPronunciation: "모오 츠이타요", meaning: "나 이미 도착했어.", category: "친구", note: "도착 알림", description: "약속 장소에 먼저 도착했을 때" },
  ...
  { japanese: "その服、すごく似合うよ。", rubySegments: [{ text: "その" }, { text: "服", reading: "ふく" }, { text: "、すごく" }, { text: "似合", reading: "にあ" }, { text: "うよ。" }], reading: "そのふく、すごくにあうよ。", koreanPronunciation: "소노 후쿠, 스고쿠 니아우요", meaning: "그 옷 정말 잘 어울려.", category: "친구", note: "칭찬", description: "외모나 스타일을 자연스럽게 칭찬할 때" },
  { japanese: "その話、面白い！", rubySegments: [{ text: "その" }, { text: "話", reading: "はなし" }, { text: "、" }, { text: "面白", reading: "おもしろ" }, { text: "い！" }], reading: "そのはなし、おもしろい！", koreanPronunciation: "소노 하나시, 오모시로이", meaning: "그 이야기 재미있다!", category: "친구", note: "반응", description: "친구 이야기에 긍정적으로 반응할 때" },
  ...
  { japanese: "この店、安くておいしいよ。", rubySegments: [{ text: "この" }, { text: "店", reading: "みせ" }, { text: "、" }, { text: "安", reading: "やす" }, { text: "くておいしいよ。" }], reading: "このみせ、やすくておいしいよ。", koreanPronunciation: "코노 미세, 야스쿠테 오이시이요", meaning: "이 가게 싸고 맛있어.", category: "친구", note: "맛집 추천", description: "친구에게 가게를 추천할 때" },
  ...
  { japanese: "その映画、もう見た？", rubySegments: [{ text: "その" }, { text: "映画", reading: "えいが" }, { text: "、もう" }, { text: "見", reading: "み" }, { text: "た？" }], reading: "そのえいが、もうみた？", koreanPronunciation: "소노 에이가, 모오 미타?", meaning: "그 영화 벌써 봤어?", category: "친구", note: "취미 대화", description: "영화 이야기를 시작할 때" },
  ...
  { japanese: "いつでも聞くよ。", rubySegments: [{ text: "いつでも" }, { text: "聞", reading: "き" }, { text: "くよ。" }], reading: "いつでもきくよ。", koreanPronunciation: "이츠데모 키쿠요", meaning: "언제든 들어줄게.", category: "친구", note: "지지", description: "친구를 응원하고 위로할 때" },
  ...
  { japanese: "また近いうちに会おう。", rubySegments: [{ text: "また" }, { text: "近", reading: "ちか" }, { text: "いうちに" }, { text: "会", reading: "あ" }, { text: "おう。" }], reading: "またちかいうちにあおう。", koreanPronunciation: "마타 치카이우치니 아오오", meaning: "또 조만간 만나자.", category: "친구", note: "마무리", description: "다음 만남을 약속하며 대화 마무리" },
  ...
  { japanese: "おやすみ、また明日。", rubySegments: [{ text: "おやすみ、また" }, { text: "明日", reading: "あした" }, { text: "。" }], reading: "おやすみ、またあした。", koreanPronunciation: "오야스미, 마타 아시타", meaning: "잘 자, 내일 또 봐.", category: "친구", note: "밤 인사", description: "메시지 대화 끝에 쓰는 인사" },
  ...
  { japanese: "また写真を撮ろう。", rubySegments: [{ text: "また" }, { text: "写真", reading: "しゃしん" }, { text: "を" }, { text: "撮", reading: "と" }, { text: "ろう。" }], reading: "またしゃしんをとろう。", koreanPronunciation: "마타 샤신오 토로오", meaning: "또 사진 찍자.", category: "친구", note: "가벼운 제안", description: "추억을 남기자고 말할 때" },
  ...
  { level: "practical", japanese: "スーパーで牛乳を買います。", rubySegments: [{ text: "スーパーで" }, { text: "牛乳", reading: "ぎゅうにゅう" }, { text: "を" }, { text: "買", reading: "か" }, { text: "います。" }], reading: "すーぱーでぎゅうにゅうをかいます。", koreanPronunciation: "스우파아데 규우뉴우오 카이마스", meaning: "마트에서 우유를 삽니다.", category: "일상", note: "쇼핑", description: "장보기 계획을 말할 때" },
  { level: "practical", japanese: "この野菜は新鮮です。", rubySegments: [{ text: "この" }, { text: "野菜", reading: "やさい" }, { text: "は" }, { text: "新鮮", reading: "しんせん" }, { text: "です。" }], reading: "このやさいはしんせんです。", koreanPronunciation: "코노 야사이와 신센데스", meaning: "이 채소는 신선합니다.", category: "일상", note: "물건 상태", description: "식재료 상태를 설명할 때" },
  { japanese: "もう少し安いものはありますか？", rubySegments: [{ text: "もう" }, { text: "少", reading: "すこ" }, { text: "し" }, { text: "安", reading: "やす" }, { text: "いものはありますか？" }], reading: "もうすこしやすいものはありますか？", koreanPronunciation: "모오 스코시 야스이 모노와 아리마스카", meaning: "조금 더 저렴한 것이 있나요?", category: "일상", note: "가격 문의", description: "쇼핑 중 가격대를 물을 때" },
  ...
  { japanese: "この薬は一日二回です。", rubySegments: [{ text: "この" }, { text: "薬", reading: "くすり" }, { text: "は" }, { text: "一日", reading: "いちにち" }, { text: "二回", reading: "にかい" }, { text: "です。" }], reading: "このくすりはいちにちにかいです。", koreanPronunciation: "코노 쿠스리와 이치니치 니카이데스", meaning: "이 약은 하루 두 번입니다.", category: "일상", note: "복용 안내", description: "약 복용 횟수를 설명할 때" },
