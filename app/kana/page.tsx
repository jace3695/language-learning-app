...
export default function KanaPage() {
  ...
  const currentStrokeDemo = currentWritingItem ? kanaStrokeDemos[currentWritingItem.char] : undefined;
  const hasStrokeDemo = Boolean(currentStrokeDemo && currentStrokeDemo.strokes.length > 0);
    ...
    <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      {mode === "writing" && currentWritingItem && (
        ...
        >
          ...
          {writingSubMode === "trace" && (
            <div style={{ marginBottom: "0.75rem", fontSize: "0.88rem", color: "#4b5563" }}>
              {writingGuideMessage}
              {writingGuideMode === "view" && hasStrokeDemo && " (SVG 획순 데이터 준비됨)"}
            </div>
          )}
          <div
            ref={writingAreaRef}
